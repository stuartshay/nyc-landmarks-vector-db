...
from nyc_landmarks.config.settings import Settings, Environment, LogLevel
...
def test_settings_defaults():
    ...
    assert settings.PINECONE_DIMENSIONS == 1536  # Should match OPENAI_EMBEDDING_DIMENSIONS
...
def test_pinecone_dimensions_match_embedding_dimensions():
    ...
    with patch.dict(os.environ, test_settings):
        ...
        assert settings.PINECONE_DIMENSIONS == 3072  # Should match OPENAI_EMBEDDING_DIMENSIONS
