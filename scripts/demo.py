...
def demo_vector_storage(chunks_with_embeddings: List[Dict[str, Any]], landmark_id: str) -> List[str]:
    ...
    vector_ids = vector_db.store_chunks(chunks_with_embeddings, id_prefix=f"{landmark_id}-demo-")
...
def demo_vector_search(query: str, landmark_id: Optional[str] = None) -> List[Dict[str, Any]]:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Demonstrate NYC Landmarks Vector Database functionality")
