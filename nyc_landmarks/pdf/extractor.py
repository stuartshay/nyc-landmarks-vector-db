...
class PDFExtractor:
    ...
    def list_pdfs(self) -> List[str]:
        ...
        try:
            ...
            pdf_blobs = [blob.name for blob in all_blobs if blob.name.lower().endswith('.pdf')]
    ...
    def process_landmark_pdf(self, landmark_id: str, blob_name: Optional[str] = None) -> Dict[str, Any]:
