...
class Settings(BaseSettings):
    ...
    PINECONE_DIMENSIONS: int = Field(default=1536)  # Should match OPENAI_EMBEDDING_DIMENSIONS
    ...
    # Chat settings
    CONVERSATION_TTL: int = Field(default=3600)  # Time to live for conversation history in seconds
