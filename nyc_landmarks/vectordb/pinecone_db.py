...
class PineconeDB:
    ...
    def store_vector(self, vector_id: str, vector: List[float], metadata: Dict[str, Any]) -> bool:
    ...
    def store_vectors_batch(self, vectors: List[Tuple[str, List[float], Dict[str, Any]]]) -> bool:
    ...
    def store_chunks(self, chunks: List[Dict[str, Any]], id_prefix: str = "") -> List[str]:
