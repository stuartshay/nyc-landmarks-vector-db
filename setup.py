...
setup(
    ...
    install_requires=[
        ...
        "python-dotenv>=1.1.0",
        "tiktoken>=0.9.0",
        "numpy>=2.2.0",  # Added for vector tests - latest version as of May 2025
        ...
        "transformers>=4.52.3",
        "openpyxl>=3.1.2",  # Added for Excel file manipulation
    ],
    extras_require={
        "dev": [
            "pytest>=7.3.1",
            ...
            "numpy>=2.2.0",  # Added explicitly for tests - latest version as of May 2025
